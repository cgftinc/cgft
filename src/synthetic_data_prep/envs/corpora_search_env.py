    ...
    def __init__(
        ...
        **kwargs,
        ...
        search_tool_definition = ToolDefinition(
            name="search_corpus",
            description=(
                "Search the corpus using BM25 with optional metadata"
                ...
                "properties": {
                    ...
                    "metadata": {
                        ...
                        "description": (
                            ...
                            "(e.g., {'ticker': 'DDOG', 'year': 2024})."
                        ),
                    },
                    "filename": {
                        "type": "string",
                        "description": (
                            "Optional filename filter. Simple string for "
                            "substring match (e.g., 'config') or regex "
                            "pattern (e.g., '.*\\.json$')."
                        ),
                    },
                    "limit": {
        ...
        super().__init__(
            ...
            **{
                ...
                if k not in ("experiment_id", "api_key")
            },
        )
